...
public class WeightSQLite extends SQLiteOpenHelper {
    ...
    private static final String CREATE_BDD = "CREATE TABLE " + TABLE_WEIGHT + " ("
            ...
            + COL_DATE + " TIMESTAMP NOT NULL," + COL_MESURE + " NUMBER NOT NULL);";

    public WeightSQLite(Context context, String name, CursorFactory factory, int version) {
